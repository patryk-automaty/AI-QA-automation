    ...
    def create_test_cases(self, state: AgentState) -> dict:
        ...
        messages = [
            ...
            HumanMessage(content=f"""Bussiness analyst provide a set of requirements in {requirements}.
                         Your goal is to act as a 'Quality Gate.' Do not just summarize; find the holes in the logic and provide a production-ready test suite. Generate 10 test cases.
                         """)
        ]
